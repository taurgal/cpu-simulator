...
var cpu = {
	step: function() {
		function setState(nextState, stageName, description) {
			...
			cpu.showHint('<span class="fetch_decode_execute ' + stagename[cpu.state].toLowerCase() + '">' + stageName + '</span>' + description);
			cpu.state = nextState;
		}
		switch(cpu.state) {
			case 0:
			setState(1, $.i18n("cpusim-fetch"), $.i18n("cpusim-pc-to-mar"));
				...
				break;
			case 1:
			setState(2, $.i18n("cpusim-fetch"), $.i18n("cpusim-load-from-mem-to-databus"));
				$('.active').removeClass('active');
				$('#ram_value_' + cpu.registers.mar).addClass('active');
			break;
			
			case 2:
			setState(3, $.i18n("cpusim-fetch"), $.i18n("cpusim-store-databus-value-into-mdr"));
			...
			case 3:
			setState(4, $.i18n("cpusim-fetch"), $.i18n("cpusim-copy-into-cir"));
			...
			case 4:
			setState(5,$.i18n("cpusim-fetch"), $.i18n("cpusim-inc-pc"));
				cpu.registers.pc++;
				cpu.updateValues();
				$('.active').removeClass('active');
			...
			case 5:
			setState(6, $.i18n("cpusim-decode"), $.i18n("cpusim-break-to-opcode-and-operand"));
				$('.active').removeClass('active');
			...
			case 6:
				...
				switch(opcode) {
					case 0:
					setState(7, $.i18n("cpusim-decode"), $.i18n("cpusim-end-program"));
					break;
					
					case 1:
					         setState(8, $.i18n("cpusim-decode"), $.i18n("cpusim-add-acc-to-mem"));
					break;
					
				    case 2:
					setState(9, $.i18n("cpusim-decode"), $.i18n("cpusim-sub-acc-to-mem"));
					break;
					
				    case 3:
					setState(10, $.i18n("cpusim-decode"), $.i18n("cpusim-store-acc-to-mem-ad-operand-addr"));
					break;
					
					case 5:
					setState(11, $.i18n("cpusim-decode"), $.i18n("cpusim-load-from-mem-to-acc-at-operand-addr"));
					break;
					
					case 6:
						     setState(12, $.i18n("cpusim-decode"), $.i18n("cpusim-branch-unconditionally"));
					break;
					
					case 7:
					setState(13, $.i18n("cpusim-decode"), $.i18n("cpusim-branch-if-acc-zero"));
					break;
					
					case 8:
					setState(14, $.i18n("cpusim-decode"), $.i18n("cpusim-branch-if-acc-non-negative"));
					break;
					
					case 9:
					setState(15, $.i18n("cpusim-decode"), $.i18n("cpusim-input-or-output"));
					break;
				}
				break;
			
			case 7:
			setState(7, $.i18n("cpusim-execute"), $.i18n("cpusim-has-halted"));
				$('.active').removeClass('active');
				cpu.running = false;
				break;
			...
			setState(81, $.i18n("cpusim-decode"), $.i18n("cpusim-send-opcode-to-mar-then-copied-to-adressbus"));
			...
			case 81: 
			setState(82, $.i18n("cpusim-execute"), $.i18n("cpusim-addrbus-to-databus"));
				$('.active').removeClass('active');
				$('#ram_value_' + cpu.registers.mar).addClass('active');
				break;
			case 82:
			setState(83, $.i18n("cpusim-execute"), $.i18n("cpusim-databus-into-mdr"));
				cpu.registers.mdr = cpu.ram[cpu.registers.mar];
				cpu.updateValues();
				$('.active').removeClass('active');
				$('#reg_mdr').addClass('active');
				break;
			case 83:
			setState(0, $.i18n("cpusim-execute"), $.i18n("cpusim-ALU-add-acc-and-mdr"));
			...
			setState(91, $.i18n("cpusim-decode"), $.i18n("cpusim-send-opcode-to-mar-then-copied-to-adressbus"));
				cpu.registers.mar = cpu.registers.cir & 0x0F;
				cpu.updateValues();
				$('.active').removeClass('active');
			...
			case 91: 
			setState(92, $.i18n("cpusim-execute"), $.i18n("cpusim-addrbus-to-databus"));
				$('.active').removeClass('active');
				$('#ram_value_' + cpu.registers.mar).addClass('active');
				break;
			case 92:
			setState(93, $.i18n("cpusim-execute"), $.i18n("cpusim-databus-into-mdr"));
				$('.active').removeClass('active');
				$('#reg_mdr').addClass('active');
				cpu.registers.mdr = cpu.ram[cpu.registers.mar];
				cpu.updateValues();
				break;
			case 93:
			setState(0, $.i18n("cpusim-execute"), $.i18n("cpusim-ALU-sub"));
			...
			setState(101, $.i18n("cpusim-decode"), $.i18n("cpusim-acc-to-mdr-to-databus"));
				...
				break;
			case 101:
			setState(102, $.i18n("cpusim-decode"), $.i18n("cpusim-operand-to-mar-to-adressbus"));
				cpu.registers.mar = cpu.registers.cir & 0x0F;
				cpu.updateValues();
				$('.active').removeClass('active');
				$('#reg_mar').addClass('active');
			break;
			case 102: 
			setState(0, $.i18n("cpusim-execute"), $.i18n("cpusim-store-databus-value-to-address-on-adressbus"));
			...
			setState(111, $.i18n("cpusim-decode"), $.i18n("cpusim-operand-to-mar-to-adressbus"));
				cpu.registers.mar = cpu.registers.cir & 0x0F;
				cpu.updateValues();
				$('.active').removeClass('active');
				$('#reg_mar').addClass('active');
			...
			case 111: 
			setState(112, $.i18n("cpusim-execute"), $.i18n("cpusim-addrbus-to-databus"));
				$('.active').removeClass('active');
				$('#ram_value_' + cpu.registers.mar).addClass('active');
				break;
			case 112:
			setState(113, $.i18n("cpusim-execute"), $.i18n("cpusim-databus-into-mdr"));
				cpu.registers.mdr = cpu.ram[cpu.registers.mar];
				cpu.updateValues();
				$('.active').removeClass('active');
				$('#reg_mdr').addClass('active');
				break;
			case 113:
			setState(0, $.i18n("cpusim-execute"), $.i18n("cpusim-mdr-to-acc"));
				cpu.registers.acc = cpu.registers.mdr;
				cpu.updateValues();
				$('.active').removeClass('active');
			...
			setState(0, $.i18n("cpusim-execute"), $.i18n("cpusim-operand-to-pc"));
			...
			setState(0, $.i18n("cpusim-execute"), $.i18n("cpusim-copy-operand-to-pc-if-acc-zero"));
			...
			setState(0, $.i18n("cpusim-execute"), $.i18n("cpusim-copy-operand-to-pc-if-acc-nonnegative"));
				if(cpu.registers.acc >= 0)
					cpu.registers.pc = cpu.registers.cir & 0x0F;
				$('.active').removeClass('active');
				cpu.updateValues();
			...
			case 15://The *opcode* 1001 means either input or output, depending on the *operand*"
				if((cpu.registers.cir & 0x0F) == 1) {
					setState(0, $.i18n("cpusim-decode"), $.i18n("cpusim-input-into-acc"));
				...
				if((cpu.registers.cir & 0x0F) == 2) {
					setState(0, $.i18n("cpusim-decode"), $.i18n("cpusim-acc-to-output"));
